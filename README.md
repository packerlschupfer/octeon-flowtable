...
Questions, hardware quirks, ports to other Octeon silicon, or just want to
compare notes on Octeon NPU programming? If you'd rather not open a GitHub issue
for every little thing, drop into the **#octeon-flowtable** channel on Discord:
